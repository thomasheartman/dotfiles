  ...
  xsession.windowManager.i3 = {
    ...
    config = {
      ...
      in rec {
        ...
        unfocused = override defaults { childBorder = "#00000000"; };
        focusedInactive = override unfocused { border = theme.disabled; };
      ...
      keybindings = let rofi = config.programs.rofi.package;
      in {
        ...
        "${super}+Control+space" =
          "exec ${rofi}/bin/rofi -show window -show-icons";
        ...
        "${alt}+Tab" =
          ''exec --no-startup-id  "${python} ${./i3-cycle-focus.py} --switch"'';
